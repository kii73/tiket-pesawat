...
if (isset($_GET["pesawat"])) {
    ...
    $pilih = $mysql->query("SELECT * FROM pesawat WHERE slug='$slug'")->fetch_assoc();

    $user = $mysql->query("SELECT * FROM users WHERE remember_token='$remember_token'")->fetch_assoc();
}
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled class="form-control" id="asal" name="asal" value="<?= $pilih["asal"] ?>" placeholder="Contoh: Jakarta" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled class="form-control" id="tujuan" name="tujuan" value="<?= $pilih["tujuan"] ?>" placeholder="Contoh: Surabaya" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" disabled id="maskapai" value="<?= $pilih["nama"] ?>" name="maskapai" placeholder="Contoh: Garuda Indonesia" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="<?= $user["nama"] ?>" disabled class="form-control" id="nama" name="nama" placeholder="Masukkan nama lengkap" required>
                        ...
                        <div class="card mb-4 border-0 shadow-sm" data-animate="animate-fade-in" data-delay="delay-200">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span>Rp <?= number_format($pilih["harga"], 0, ',', '.') ?></span>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="d-flex justify-content-between fw-bold">
                                    <span>Total</span>
                                    <span class="text-primary" id="total-price">Rp <?= number_format($pilih["harga"] + 150000, 0, ',', '.') ?></span>
                                </div>
                            </div>
                        </div>
